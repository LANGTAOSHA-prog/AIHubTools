...
const UI_TEXT = {
  zh: {
    ...
    toolsTitle: '工具列表',
    toolsHint: '数据来自 tools-data.json，可由 Make 自动从 Google 表格同步到 GitHub。',
    searchLabel: '搜索工具',
    ...
    aboutText: '这是一个适合 GitHub Pages 的轻量级多语言工具导航网站。你可以在 Google 表格中维护工具数据，通过 Make 自动生成 tools-data.json 并上传到 GitHub。',
    footerText: '智汇工具',
    loading: '正在加载工具数据...',
  ...
  en: {
    ...
    toolsHint: 'Data comes from tools-data.json and can be synced from Google Sheets to GitHub by Make.',
    ...
    aboutText: 'A lightweight multilingual tools directory for GitHub Pages. Maintain tools in Google Sheets, generate tools-data.json with Make, and upload it to GitHub automatically.',
  ...
  ja: {
    ...
    directoryLabel: 'Tools Directory',
    toolsTitle: 'ツール一覧',
    toolsHint: 'データは tools-data.json から読み込み、MakeでGoogle SheetsからGitHubへ自動同期できます。',
    searchLabel: 'ツール検索',
    ...
    aboutText: 'GitHub Pages向けの軽量な多言語ツールナビサイトです。Google Sheetsでデータを管理し、Makeでtools-data.jsonを生成してGitHubへ自動アップロードできます。',
    footerText: 'AIツールナビ',
